            ...
            <div class="col-lg-6">
              <div class="card-body p-md-5 mx-md-4">
                ...
                <div class="text-center">
                  ...
                  <h4 class="mt-2 mb-5 pb-1">Please Login To Your Account</h4>
                </div>

                <form action="login.php" method="POST">
                  <div class="form-outline mb-4">
                    <label class="form-label" for="form2Example11 mb-2">Username</label>
                    <input type="text" name="txUSER" id="form2Example11" class="form-control"
                      placeholder="Masukan Username" />
                  </div>

                  <div class="form-outline mb-4">
                    <label class="form-label" for="form2Example22 mb-2">Password</label>
                    <input type="password" name="txPASS" id="form2Example22" class="form-control" 
